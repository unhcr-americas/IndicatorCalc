...
fct_re_map <- function(datalist, mapper){
   ...
   for ( i in 1:nrow(mapper[["variablemap"]]) ) {
    ...
    if ( nrow(thismatch) ==0) { cli::cli_alert_info(paste0( thisvar ,
           " variable pattern was not found in the dataset.\n"))
      }
     else if ( nrow(thismatch) > 1) {cli::cli_alert_info(paste0( thisvar ,
            " variable pattern has more than one match in the dataset.\n")) }
     else {
     ## Now  transform
